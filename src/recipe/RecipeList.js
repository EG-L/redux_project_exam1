...
function RecipeList(){
    ...
    // reducer 전송 => 요청 처리 => 변경된 데이터를 store에 저장
    useEffect(() => {
        ...
        <div className="col-md-4">
            <div className="thumbnail">
                <Link to={"/recipe/recipe_detail/"+recipe.no}>
                    <img src={recipe.poster} title={recipe.title} alt="Lights" style={{"width": "100%"}}/>
        ...
        <Fragment>
            ...
            <div className={"row"}>
                <div className={"text-center"}>
                    <Pagination activePage={curpage} itemsCountPerPage={12} totalItemsCount={recipe_total}
